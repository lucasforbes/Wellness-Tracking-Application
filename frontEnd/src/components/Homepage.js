...
//test
    return (
        <>
            ...
            <Row style={{backgroundColor: 'lightgrey', borderStyle: 'square', padding: '3%', overflow: 'hidden'}}>

                <div className={'col-xs-4'}>
                    <Card style={{width: '50%', borderColor: 'Red Orange', borderWidth: '7px', height:'100%', position: 'relative', left: ''}}>
                ...
                <div className={'col-xs-4'}>
                    <Card style={{width: '50%', borderWidth: '7px', borderColor: 'Blue Green', position: 'relative', left: '', height: '100%'}} bg='light'>
                        <Card.Img style={{height: '50%'}} variant="top" src="forksandknivesss.jpg"/>
                        <Card.Body>
                ...
                <div className={'col-xs-4'}>
                    <Card style={{width: '50%', borderColor: 'Purple Blue', borderWidth: '7px', height:'100%', position: 'relative', left: ''}} bg='light'>
